...
public class SampleAppTest {
    ...
    private void setUp() {
        ...
        if (platform.equals("ANDROID")) {
            ...
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Pixel_3_XL");
            ...
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iPhone 11 (13.3)");
            capabilities.setCapability(MobileCapabilityType.UDID, "2FC4280D-EB6C-4306-B76A-82B6D37CFD1B");
